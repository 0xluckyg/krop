...
class SurveyResponses extends React.Component {
    ...
    fetchSurveyResponses(page, params) {
        ...
        axios.get(process.env.APP_URL + '/get-responses', {
            ...
            this.props.showToastAction(true, "Couldn't get survey responses. Please try again later.")
            return err
        })
    }
    ...
    renderTablePagination() {        
        ...
        const handleBackButtonClick = () => {
            this.fetchSurveyResponses(page - 1)
        }
        ...
        const handleLastPageButtonClick = () => {
            this.fetchSurveyResponses(totalPages)
        }        
    ...
    renderTableFooter() {
        const {responses, total, page} = this.state   
            ...
            <TableFooter>
                ...
                <TablePagination
                    ...
                    labelDisplayedRows={() => {
                        ...
                        return `${current + 1} - ${current + responses.length} of ${total}`
                    }}
                    SelectProps={{
