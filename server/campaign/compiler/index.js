...
async function compiler(campaignOptions) {
    const frameHTML = compileFrameHTML(campaignOptions).outerHTML
    const pageHTML = compilePageHTML(campaignOptions).outerHTML
    const buttonHTML = compileButtonHTML(campaignOptions).outerHTML
    const alertHTML = compileAlertHTML(campaignOptions).outerHTML
    const alertTextHTML = compileAlertTextHTML(campaignOptions).outerHTML
    ...
    let js = await compileJS(campaignOptions)
