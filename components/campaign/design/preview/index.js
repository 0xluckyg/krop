...
const useStyles = theme => ({    
    ...
    campaignContainer: props => {
        let style = isDesktop(props) ? frameStyles.CAMPAIGN_CONTAINER_DESKTOP : frameStyles.CAMPAIGN_CONTAINER
        return {
            ...style
        }
    },
    campaignWrapper: props => {
        let style = isDesktop(props) ? frameStyles.CAMPAIGN_WRAPPER_DESKTOP : frameStyles.CAMPAIGN_WRAPPER
        return {
            ...style
        }
    },
...
export default withStyles(useStyles)(CampaignPreview)